...
//     // Validate time input to be between 1 and 12
//     if (name === 'time') {
//       console.log('Timeee');
//       // Regular expression to match the time format (hh:mm)
//       const timeRegex = /^(0?[1-9]|1[0-2]):[0-5][0-9]$/;
//       console.log('Timeee123');
//       // Check if the entered value matches the time format
...
//         const enteredTime = parseInt(hours, 10);
  
//         // Check if the entered value is within the range of 1 to 12
//         if (enteredTime < 1 || enteredTime > 12) {
//           console.log('Time checked');
//           // If the entered value is not within the range, set an error
//           setErrors({
//             ...errors,
//             time: 'Time must be between 1 and 12',
//           });
//         } else {
//           // If the entered value is valid, clear any existing errors
//           setErrors({
//             ...errors,
//             time: '', // Clear the error message
//           });
//         }
//       }
//     }
