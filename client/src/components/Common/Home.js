    ...
    <div className="img1">
      ...
      <div class="overlay3">
        ...
        <div class="overlay-text">
          ...
          <p class="ph">
            Registration opens on June 3, 2024 at 12:00am. SPOTS ARE
            LIMITED...BE SURE TO REGISTER EARLY!
          </p>
          <p class="ph">
            Registration will be accepted on a first-come, first-served basis.
            Spots are limited in each division. Once a division is full, no more
            entries will be accepted for that division
          </p>
          <p class="ph">
            Payment must be made in FULL in order for registration to be
            processed.
          </p>
          ...
          <button type="button" class="btn btn-primary btn-lg custom-btn">
            {" "}
            <a href="/CandidateSignup" style={{ color: "white" }}>
              Register To A Event
            </a>
          </button>
        </div>
      ...
      <div className="overlay4">
        <div className="butt">
          <button type="button" class="btn btn-primary btn-lg custom-btn3">
            2023 MEDALISTS{" "}
          </button>
          <button type="button" class="btn btn-primary btn-lg custom-btn3">
            2023 RESULTS
      ...
      <p></p>
      <button className="btn btn-success">
        <a href="/managerSignin" style={{ color: "black" }}>
      ...
      <p></p>
      <button className="btn btn-success">
        <a href="/AdminSignin" style={{ color: "black" }}>
          Admin Sign In
        </a>
      </button>
      <p></p>
      <button className="btn btn-success">
        <a href="/JudgeSignup" style={{ color: "black" }}>
          Sign In as a judge
        </a>
      </button>
    </div>
